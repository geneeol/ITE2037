public class LateBindingDemo {
	public static void main(String[] args) {
		...
		DiscountSale discount = new DiscountSale("floor mat", 11.00, 10); // One item at $11.00 with a 10% discount.
		...
		DiscountSale specialPrice = new DiscountSale("cup holder", 11.00, 10); // One item at $11.00 with a 10% discount.
